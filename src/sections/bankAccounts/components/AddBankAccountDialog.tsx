...
export default function AddBankCardDialog({ open, onClose, onSaved }: Props) {
  ...
  const rtlCache = useMemo(
    () => createCache({ key: 'mui-rtl-add-bank-card', stylisPlugins: [rtlPlugin] }),
    []
  );
    ...
    // <CacheProvider value={rtlCache}>
      <ThemeProvider theme={rtlTheme}>
        <Dialog
          ...
          fullWidth
          maxWidth="sm"
          aria-labelledby="add-bank-card"
        >
          <DialogTitle id="add-bank-card">افزودن کارت بانکی</DialogTitle>
          <Divider />
